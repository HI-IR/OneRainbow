package com.onerainbow.page.home.activity
...
import com.onerainbow.page.top.view.TopFragment
import com.onerainbow.page.home.R
import com.onerainbow.page.home.databinding.ActivityHomeBinding
...
class HomeActivity : BaseActivity<ActivityHomeBinding>() {
    ...
    private fun initVp2() {
        binding.apply {
            vp2Home.let {
                //配置适配器
                it.adapter = HomeVpAdapter(this@HomeActivity).add (fragments)
