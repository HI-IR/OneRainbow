...
import com.onerainbow.page.top.adapter.TopVp2Adapter
import com.onerainbow.page.top.databinding.FragmentTopBinding
...
class TopFragment : BaseFragment<FragmentTopBinding>() {
	...
	private fun initView() {
		binding.topVp2.adapter = TopVp2Adapter(this).add(fragments)
		//tab的设置
		binding.apply {
