...
import com.onerainbow.page.recommend.bean.Creator2
import com.onerainbow.page.recommend.bean.Playlist
import com.onerainbow.page.recommend.databinding.ItemToplistBinding
import com.onerainbow.page.search.data.Creator
...
class TopListAdapter(private val context: Context) :
    ...
    inner class ViewHolder(binding: ItemToplistBinding) : RecyclerView.ViewHolder(binding.root) {
        ...
        fun Playlist.toSimple(): Playlists {
            return Playlists(
