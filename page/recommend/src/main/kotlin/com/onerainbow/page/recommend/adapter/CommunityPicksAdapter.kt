package com.onerainbow.page.recommend.adapter
...
import com.onerainbow.page.recommend.R
import com.onerainbow.page.recommend.bean.Creator
import com.onerainbow.page.recommend.bean.Playlists
import com.onerainbow.page.recommend.databinding.ItemCommunityPicksBinding
...
class CommunityPicksAdapter(private val context: Context) :
    ListAdapter<List<Playlists>, CommunityPicksAdapter.ViewHolder>(object : DiffUtil.ItemCallback<List<Playlists>>(){
    ...
    inner class ViewHolder(binding:ItemCommunityPicksBinding):RecyclerView.ViewHolder(binding.root){
        ...
        fun Playlists.toSimple(): com.onerainbow.page.search.data.Playlists{
            return com.onerainbow.page.search.data.Playlists(
        ...
        fun Creator.toSimple(): com.onerainbow.page.search.data.Creator {
            return com.onerainbow.page.search.data.Creator(
